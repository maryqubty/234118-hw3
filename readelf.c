...
int counter=0;       // declaring and initializing global variable to count globals in part 2  //////////////////////////////////////////////////////////////////
...
#define CHECK_ENTSIZE(section, i, type)					\
  ...
  for (i = 0, section = filedata->section_headers;
	...
	printf ("%s\n      ", printable_section_name (filedata, section));
        ...
        char* new_name =(char*) malloc(sizeof(char)*(MAX_PRINT_SEC_NAME_LEN+8));
        //new_name = SECTION_NAME_PRINT(section);
        //char new_name[1000];
        strcpy(new_name, SECTION_NAME_PRINT(section));
        strcat(new_name, "_<3KIREL");
	print_symbol (-17, new_name);
        free(new_name);
        }
       }
...
// counter++ in case found global ////////////////////////////////////////////////////////////////////////////////////////////////////////// 
if (strcmp(get_symbol_binding(filedata, ELF_ST_BIND (psym->st_info) ),"GLOBAL")==0) {counter++;} 
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
printf ("There are %d GLOBAL symbols in this file.\n", counter); 
